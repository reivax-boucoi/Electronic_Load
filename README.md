...
**You will have to restart the load in order for the changes to take effect.** This is done to prevent happy little accidents. To start and stop the load, press the rightmost button. The rightmost blue LED should light up. Is the LED turns red, a fault occured. Faults can happen if :
